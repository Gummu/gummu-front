    ...
    return (
        <div className="flex overflow-y-auto overflow-x-hidden min-h-screen max-h-screen text-white bg-dark">
            <div className="flex flex-col max-h-screen bg-black app grow">
                <div className="flex searchbar bg-dark_alt w-full h-20">
                    ...
                    <div className="w-20 flex justify-center items-center">
                                <svg
                                    ...
                                    className="fill-orange-500 h-20 w-20 m-auto flex-1"
                                >
                ...
                <div className="overflow-auto p-5 pb-24 w-full content">
                    <div class="flex">
                        {/* <div className="w-48 bg-dark_alt">test</div> */}
                    </div>
                </div>
            </div>

            <div className="absolute bottom-0 w-full h-20 bg-dark_alt player"></div>
        </div>
    );
}
